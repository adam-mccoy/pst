...
namespace Pst.Tests
{
    ...
    {
        #region Test Data
        private static readonly byte[] NodeData = new byte[]
        {
        ...
        private static readonly byte[] SubNodeTree = new byte[]
        {
        ...
        private static readonly byte[] SubNodeData = new byte[]
        {
        ...
        private static readonly object[] CellDataCases =
        {
        ...
        public void Gets_Cell_Data(int rowIndex, PropertyKey key, byte[] expectedBytes)
        {
            ...
            reader.Setup(r => r.FindBlock(0x538))
                .Returns(Block.Create(NodeData));
            reader.Setup(r => r.FindBlock(0x542))
                .Returns(Block.Create(SubNodeTree));
            reader.Setup(r => r.FindBlock(0x53c))
                .Returns(Block.Create(SubNodeData));
